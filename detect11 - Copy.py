...
def send_notification():
   ...
   # print(map_link)
    print()
    bot.sendMessage(chat_id, 'Dog identified  ' + map_link)
...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        if ("dog" in s) or ("cat" in s) or ("stick" in s) or ("rod" in s) or ("cover" in s) or ("hand" in s) or ("person" in s) or ("cloth" in s) or ("cow" in s) or ("buffalo" in s):
            send_notification()
